...
def sell_loss_positions(stdate, eddate, data_port_cp, sldate):
    ...
    path_save = 'sell_loss_positions_' + stdate + '_' + eddate + '_' + sldate + '_.csv'
...
if __name__ == '__main__':
    ...
    sell_loss_positions(st, sd, data_port_cp, sldt)
