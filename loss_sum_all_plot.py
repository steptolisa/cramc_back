...
def loss_sum_all_plot_f(df, date_st, date_ed, field):
...
#     print(df_g)
    ...
    for dttime in date_ls:
        ...
        sr_dttime = df_dttime.ix[(df_dttime.UNREALIZED_CNY<=0),'UNREALIZED_CNY']
...
#     date_st = '20180115'
    ...
    loss_sum_all_plot_f(data_port_cp, date_st, date_ed, field)
